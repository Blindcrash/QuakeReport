...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            //Esta parte es donde con JSON se busca por medio de la url, los datos deseados, primero features, luego properties
            // y luego finalmente los atributos que buscamos con el programa
